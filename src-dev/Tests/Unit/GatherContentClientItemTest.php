...
class GatherContentClientItemTest extends GcBaseTestCase
{
    ...
    public function casesItemUpdatePostFail()
    {
    ...
    /**
     * @dataProvider casesItemUpdatePostFail
     */
    public function testItemUpdatePostFail(array $expected, array $response, $itemId, array $content)
    {
        $tester = $this->getBasicHttpClientTester([
            new Response(
                $response['code'],
        ...
        $gc->itemUpdatePost($itemId, $content);
    }
